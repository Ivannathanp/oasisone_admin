      ...
      <div className="backgroundcontainer">
        <div className="contractinnercontainer">
          ...
          <div className="contracttext">
            Sorry, your contract periode with Oasis One has ended. Please
            contact management to renew your contract to continue using our
            services.
          </div>
...
export default connect(mapStateToProps, { logoutUser })(RenewContractPage);
